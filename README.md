...
> Названия колонок могут быть любыми — главное, чтобы в проекте были корректно сопоставлены поля “бренд / артикул / наименование” и чтобы поля были в 1 строчке. Мрковый эксель можно найти в корне репозитория mockExcel
